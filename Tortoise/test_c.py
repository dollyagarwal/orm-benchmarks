...
async def _runtest_warehouse(count, citys):
    ...
    await warehouse.bulk_create(w_l)
...
async def _runtest_district(count, citys):
    ...
    await district.bulk_create(d_l)
...
async def _runtest_customer(count, names, last_names, citys):
    ...
    await customer.bulk_create(c_l)
...
async def populate(n):
    ...
    print(f"Tortoise Testcase C, warehouse: Rows: {w_c} , Time: {(now - start)}")
    print(f"Tortoise Testcase C, warehouse: Rows/sec: {w_c / (now - start): 10.2f}, timestamp: {datetime.now()}")
    ...
    print(f"Tortoise Testcase C, district: Rows: {d_c} , Time: {(now - start)}")
    print(f"Tortoise Testcase C, district: Rows/sec: {d_c / (now - start): 10.2f}, timestamp: {datetime.now()}")
    ...
    print(f"Tortoise Testcase C, customers: Rows: {c_c} , Time: {(now - start)}")
    print(f"Tortoise Testcase C, customers: Rows/sec: {c_c / (now - start): 10.2f}, timestamp: {datetime.now()}")
    ...
    print(f"Tortoise Testcase C, items: Rows: {i_c} , Time: {(now - start)}")
    print(f"Tortoise Testcase C, items: Rows/sec: {i_c / (now - start): 10.2f}, timestamp: {datetime.now()}")
    ...
    print(f"Tortoise Testcase C, stock: Rows: {s_c} , Time: {(now - start)}")
    print(f"Tortoise Testcase C, stock: Rows/sec: {s_c / (now - start): 10.2f}, timestamp: {datetime.now()}")
