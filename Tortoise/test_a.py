...
async def populate(n):
    ...
    print(f"Tortoise Testcase A, warehouse: Rows: {w_c} , Time: {(now - start)}")
    print(f"Tortoise Testcase A, warehouse: Rows/sec: {w_c / (now - start): 10.2f}, timestamp: {datetime.now()}")
    ...
    print(f"Tortoise Testcase A, district: Rows: {d_c} , Time: {(now - start)}")
    print(f"Tortoise Testcase A, district: Rows/sec: {d_c / (now - start): 10.2f}, timestamp: {datetime.now()}")
    ...
    print(f"Tortoise Testcase A, customers: Rows: {c_c} , Time: {(now - start)}")
    print(f"Tortoise Testcase A, customers: Rows/sec: {c_c / (now - start): 10.2f}, timestamp: {datetime.now()}")
    ...
    print(f"Tortoise Testcase A, items: Rows: {i_c} , Time: {(now - start)}")
    print(f"Tortoise Testcase A, items: Rows/sec: {i_c / (now - start): 10.2f}, timestamp: {datetime.now()}")
    ...
    print(f"Tortoise Testcase A, stock: Rows: {s_c} , Time: {(now - start)}")
    print(f"Tortoise Testcase A, stock: Rows/sec: {s_c / (now - start): 10.2f}, timestamp: {datetime.now()}")
